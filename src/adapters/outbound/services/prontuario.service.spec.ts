...
describe('ProntuarioService', () => {
  ...
  it('deve listar arquivos', async () => {
    ...
    const result = await prontuarioService.listarArquivos(sub);
  ...
  it('deve compartilhar um arquivo', async () => {
    ...
    const result = await prontuarioService.compartilharArquivo(key, sub);
  ...
  it('deve fazer upload de um arquivo', async () => {
    ...
    const result = await prontuarioService.enviarArquivo(sub, await buffer(stream), key);
